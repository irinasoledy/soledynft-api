    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 lngwLogo">
                ...
                <a href="{{ url('/'.$lang->lang.'/homewear') }}" class="logo"><img src="/fronts/img/icons/logonew1.png" alt="logo"/></a>
            </div>
            ...
            <ul class="col-lg-4 col-12">
                ...
                <li><a href="{{ url('/'.$lang->lang.'/homewear/catalog/all') }}">{{ trans('vars.General.HomewearStore') }}</a></li>
